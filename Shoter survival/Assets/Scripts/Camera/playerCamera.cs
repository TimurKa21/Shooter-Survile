...
public class playerCamera : MonoBehaviour
{
    ...
    [Header("Distance")]
    public float distance = 4.0f; // The current distance to target
    ...
    public float zoomFOV = 30f;      // Значение FOV при зуме (меньше - ближе)
    public float defaultFOV = 60f;   // Обычное значение FOV
    ...
    protected virtual void Update()
    {
        ...
        PlayerTransform.rotation = Quaternion.Slerp(PlayerTransform.rotation, Quaternion.Euler(0, x, 0), followSpeed * Time.deltaTime);
    }
